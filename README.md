...
In future, I _might_ properly functionize the scripts, improve the Typescript server, _possibly_ look at hooking into the React dev overlay for error reporting, "eject"... and more, periodically, if time permits.
